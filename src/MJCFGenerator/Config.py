...
PARKING_SPOT_KWARGS = {"pos":(2, 5, 0), "euler":(0, 0, 0)}
PARKING_SPOT_PADDINGS = (1.5, 2.5)
...
TRAILER_HITCH_ANGLE_LIMIT = (-95, 95)
TRAILER_HITCH_ANGLE_LIMIT_RADIANS = np.radians(TRAILER_HITCH_ANGLE_LIMIT)
